...
function PlanCard({
  ...
  return (
    <div className="w-full max-w-sm mx-auto bg-white border rounded-2xl p-6 relative shadow-md transform transition-all duration-300 hover:-translate-y-2 hover:shadow-2xl">
      {plan.popular && (
  ...
  return (
    <div className="w-full max-w-5xl mx-auto">
      ...
      <div className="md:hidden mt-8 w-full">
        <div className="flex overflow-x-auto no-scrollbar snap-x snap-mandatory scroll-smooth w-full">
          {plans.map((plan) => (
            <div key={plan.name} className="snap-center shrink-0 w-full px-2">
              <PlanCard
                plan={plan}
                company={company}
                role={role}
